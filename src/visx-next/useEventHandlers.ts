 ...
 */
export function useEventHandlers<XScale extends AxisScale, YScale extends AxisScale, Datum extends object>({
  dataKey,
  ...
  const getHandlerParams = useCallback(
    (params?: HandlerParams) => {
      ...
      if (params && event && svgPoint && width && height && !isNil(xScale) && !isNil(yScale)) {
