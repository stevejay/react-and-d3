...
//     offset
//   }: {
//     previousPosition: (d: d3.NumberValue) => number | null;
//     position: (d: d3.NumberValue) => number;
//     tickValue: d3.NumberValue;
//     translate: 'translateX' | 'translateY';
//     offset: number;
//   }) => {
//     const initialPosition = previousPosition ? previousPosition(tickValue) : null;
...
//     offset: number;
//   }) => {
//     return { opacity: 1, [translate]: position(tickValue) + offset };
//   },
//   exit: ({
//     previousPosition,
//     position,
...
//   exit: (newPosition: (d: d3.NumberValue) => number) => {
//     const exitPosition = newPosition(tickValue);
//     return isFinite(exitPosition) ? { opacity: 0, [translate]: exitPosition + offset } : { opacity: 0 };
//   }
// };
