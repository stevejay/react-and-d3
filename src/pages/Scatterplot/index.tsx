...
function Scatterplot() {
  return (
    <main className="w-full max-w-3xl p-4 mx-auto md:p-8">
      ...
      <Helmet>
        <title>Scatterplot - React and D3</title>
      </Helmet>
      ...
      <Paragraph>
        ...
        with it. Unfortunately the axes also need to be updated, so the chart as a whole has to redrawn. This
        is expensive when done via React, and you will likely notice performance issues on mobile.
      </Paragraph>
