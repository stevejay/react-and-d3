  ...
  <>
    ...
    <div className="w-full max-w-3xl p-4 mx-auto space-y-8 md:p-8">
      <Paragraph>
        ...
        to render your charts, you are going to need a replacement. This page demonstrates my own port of the
        D3 axis to React. The main complication I had was recreating the animations. Entering ticks animate in
        based on the previous scale and exiting ticks animate out based on the new scale. Luckily Framer
        Motion can handle this well. You can try some examples below of various D3 axes and their React
        equivalent.
      </Paragraph>
      <HorizontalRule />
      ...
      <Paragraph>
        ...
        version of the React axis component that improves the exit animations, but is still not perfect. It is
        also significantly more complex in implementation. You can try this alternate version below.
      </Paragraph>
      <HorizontalRule />
      ...
      <Paragraph>
        ...
        custom axis. I find it easier to create a custom React axis rather than a custom D3 axis, and it will
        also be more maintainable. The following is an example of a custom time axis in React.
      </Paragraph>
      <HorizontalRule />
