...
import { TempTabbableTooltipBarChartWithTooltip } from './TempTabbableTooltipBarChartWithTooltip';
...
export const TabbableTooltipBarChartExample: FC = () => {
  ...
  return (
    <ExamplesSectionWrapper>
      <ExampleChartWrapper title="Tabbable Tooltip" sizerClassName="h-96">
        {({ inView, width, height, ariaLabelledby }) =>
          inView && (
            <TempTabbableTooltipBarChartWithTooltip
