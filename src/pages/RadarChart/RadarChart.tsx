...
export const RadarChart = memo(
  forwardRef<SVGSVGElement, RadarChartProps>(
    ({ label, compact, selectedKey, data, diameter, onSelect, onShowTooltip, onHideTooltip }, ref) => {
      const id = useId();
      ...
      return (
        <MotionConfig transition={{ duration: 0.3, ease: d3.easeCubicInOut }}>
          <Svg
            ref={ref}
            width={diameter}
            height={diameter}
                  ...
                  <>
                    <motion.circle
                      ...
                      animate={{
                        ...
                        cy: (radialPointLookup.get(d.key)?.[1] ?? 0) + 0.5,
