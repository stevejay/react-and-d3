...
const Home = () => (
  <div>
    ...
    >
      <div className="flex flex-col-reverse items-center justify-between px-16 py-8 overflow-hidden border-b lg:flex-row border-slate-600 bg-gradient-to-t lg:bg-gradient-to-r from-slate-900 lg:via-slate-900 to-transparent">
